...
**Project**: pixel-perfect-hero 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Please recreate this hero section. Follow the color schema and the font sizes and font types to the letter. 
...
```sh
git clone https://github.com/GPT-Engineer-App/pixel-perfect-hero.git
cd pixel-perfect-hero
npm i
